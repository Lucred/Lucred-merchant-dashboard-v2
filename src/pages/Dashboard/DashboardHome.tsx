      ...
      <div className="mx-[3%] ">
        ...
        <div className=" flex flex-col lg:flex-row items-center justify-between ">
          ...
          <div className="my-[3%] w-[50%] flex justify-center lg:justify-end ">
            <img src={seemore} alt="" className="h-[27.8vh]" />
            <button className="text-[#533AE9] font-[600]  absolute bg-[#fff] lg:bottom-[-5%] md:bottom-[-42%] bottom-[-18%]  lg:top-[50%]   lg:mr-[3.5%] h-[5vh]">
              See More
            </button>
          </div>
        </div>
...
const TransactionTable = () => {
  return (
    <div className="bg-[#fff] w-[100%]  py-[3%] px-[4%] my-[2%] rounded-md">
      <div className="pb-[2%]">
        <h3 className="text-[#000000] font-[500] text-[1.2rem] mb-[4px]">Top Transaction</h3>
...
const TopProduct = () => {
  return (
    <div className="bg-[#fff] w-[100%] md:w-[50%] lg:w-[80%] rounded-md py-[4%] px-[4%] mx-[auto]">
      <div className="pb-[2%]">
        <h3 className="text-[#000000] font-[500] text-[1.2rem] mb-[4px]">Top Product</h3>
        <p className="text-[#9C9AA4] text-[0.8rem] mb-[10px]">
