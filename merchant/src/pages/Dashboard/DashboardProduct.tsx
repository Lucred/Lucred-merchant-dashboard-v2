        ...
        <div className='mx-[3%]'>
            ...
            <div className='bg-[#fff] py-[2%] px-[1%]'>
                <div className='flex items-center justify-between'>
                    <div className='w-[25%] bg-[#FFFFFF] flex items-center justify-center h-[5vh] border border-[#C3C3C4] rounded-md'>
                    ...
                    <Link to="/dashboard/add-product" className='bg-[#533AE9] w-[20%] h-[5vh] text-[#fff] mr-[5%] rounded-md flex justify-center items-center'>Add Product</Link>
                </div>
                ...
                <table className=' w-[100%] border rounded-md my-[2%]'>
                    ...
                    <tr className='bg-[#1100770A] text-[0.8rem] text-[#56555B] text-center w-[100%] '>
                        ...
                        <td className='font-[400] flex items-center justify-center h-[5vh]'><img src={view} alt="" /> <img src={edit} alt="" /> <img src={trash} alt="" />  </td>
