    ...
    export const MinSidebar = () => {
        return (
            <div className='w-[10%] bg-[#533AE9] fixed h-[100vh] py-[5%] '>
                <img src={lucredMini} alt="Lucred" className='  ' />
               <ul className='h-[60vh] flex flex-col justify-evenly items-center ml-[5%]'>
                    <li><Link to={'/dashboard'} className='text-[#fff] flex pl-[5%] items-center '><img src={home} alt="" className='h-[2vh] mr-[5%]'/></Link></li>
                    <li><Link to={'/dashboard/add-product'} className='text-[#fff] flex pl-[5%] items-center '><img src={addProduct} alt="" className='h-[2vh] mr-[5%]'/></Link></li>
                    <li><Link to={'/dashboard/sales-info'} className='text-[#fff] flex pl-[5%] items-center '><img src={sales} alt="" className='h-[2vh] mr-[5%]'/></Link></li>
                    <li><Link to={'/dashboard/profile'} className='text-[#fff] flex pl-[5%] items-center '><img src={profile} alt="" className='h-[2vh] mr-[5%]'/></Link></li>
                    <li><Link to={'/dashboard/user-guide'} className='text-[#fff] flex pl-[5%] items-center '><img src={userGuide} alt="" className='h-[auto] mr-[5%]'/></Link></li>
                    <li><Link to={'/dashboard/customer-report'} className='text-[#fff] flex pl-[5%] items-center '><img src={userReport} alt="" className='h-[2vh] mr-[5%]'/></Link></li>
                    <li><Link to={'/dashboard/settings'} className='text-[#fff] flex pl-[5%] items-center '><img src={settings} alt="" className='h-[2vh] mr-[5%]'/></Link></li>
                    <li><Link to={''} className='text-[#fff] flex pl-[5%] items-center '><img src={help} alt="" className='h-[2vh] mr-[5%]'/></Link></li>
                    <li><Link to={''} className='text-[#fff] flex pl-[5%] items-center '><img src={logout} alt="" className='h-[2vh] mr-[5%]'/></Link></li>
                </ul>
