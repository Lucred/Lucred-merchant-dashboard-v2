...
const Login = () => {
  return (
    <div className='flex justify-between px-[5%] py-[3%] h-[100vh] '>
        <div className='w-[50%] py-[5%] pl-[5%]'>
            ...
            <div className=''>
                ...
                <div className='text-left my-[2%]' >
                    ...
                    <input type="text" placeholder="Enter your email" className='border rounded-md w-[70%] pl-[5%] py-[1%]' />
                </div>
                <div  className='text-left'>
                    <label>Password</label><br></br>
                    <input type="password" placeholder="Enter your password" className='border rounded-md w-[70%] pl-[5%] py-[1%]' />
                </div>
                ...
                <p className=' text-center w-[70%] my-[3%]'>Want to become a Merchant? Sign up</p> 
        ...
        <div className='flex flex-col items-center justify-center bg-[#1100770A] w-[50%] rounded-md py-[5%] text-center'>
            <h2 className='text-[2.2rem] text-[#110077] font-[600]'>Increase Sales with Lucred</h2>
            ...
            <img src={loginImg} alt="loginImg" className='h-[65vh] my-[3%]' />
        </div>
